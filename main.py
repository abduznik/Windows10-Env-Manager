...
# Create buttons
button_image_1: PhotoImage = PhotoImage(file=relative_to_assets("button_1.png"))
...
button_image_2: PhotoImage = PhotoImage(file=relative_to_assets("button_2.png"))
...
button_image_3: PhotoImage = PhotoImage(file=relative_to_assets("button_3.png"))
